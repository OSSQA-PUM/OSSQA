...
def dependency_manager_5_dependencies():
    ...
    """
    dep1 = Dependency(name="github.com/repo/path", component_name="comp", version="1.0")
    dep2 = Dependency(name="github.com/repo/path", component_name="comp", version="2.0")
    dep3 = Dependency(name="github.com/repo/path", component_name="comp", version="3.0")
    dep4 = Dependency(name="github.com/repo/path", component_name="comp", version="4.0")
    dep5 = Dependency(name="github.com/repo/path", component_name="comp", version="5.0")
...
def test_dependency_manager_update_same_dependency(
    ...
    dependency_manager = dependency_manager_5_dependencies
    new_dep = Dependency(name="github.com/repo/path", component_name="comp", version="5.0")
...
def test_dependency_manager_replace_scored_with_unscored(
    ...
    new_dep = Dependency(name="github.com/repo/path", component_name="comp", version="1.0")
    dependency_manager.update([new_dep])
